 ...
 *     参数：
 *      InputStream in：字节输入流。可以传递FileInputStream对象增加一个缓冲区，提高FileInputStream的读取效率
 *      int size：缓冲区的大小，不写默认
 * 使用步骤：
 *   1.创建FileInputStream(字节输入流对象)，构造方法中绑定要读取的数据源
 *   2.创建BufferedInputStream对象，构造方法中传递FileInputStream对象，提高FileInputStream对象效率
 *   3.使用BufferedInputStream对象的中的方法read，读取文件
 *   4.释放资源
 */
public class Demo02BufferedInputStream {
    public static void main(String[] args) throws IOException {
        FileInputStream fis = new FileInputStream("F:\\LJF\\qq.txt");
