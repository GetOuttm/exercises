...
public class JDProcessor1 implements PageProcessor {
    /**
     * 负责解析 页面
     * @param page page
     */
    ...
    public void process(Page page) {
        ...
        //演示url去重
        page.addTargetRequest("https://kuaibao.jd.com/article?id=235014423");
        page.addTargetRequest("https://kuaibao.jd.com/article?id=235014423");
        page.addTargetRequest("https://kuaibao.jd.com/article?id=235014423");
    }
    ...
    public static void main(String[] args) {
        //设置爬取数据得页面
        Spider spider = Spider.create(new JDProcessor1())
...
//                .addPipeline(new FilePipeline("D:\\桌面\\面试\\a"))//输出
        ...
        Scheduler scheduler = spider.getScheduler();//duplicatedRemover=HashSetDuplicatRemover
